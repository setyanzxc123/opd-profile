...
class CoreSeeder extends Seeder
{
    public function run()
    {
        ...
        if (! $this->db->table('news')->countAllResults()) {
            ...
            $twoDaysAgo  = Time::now('UTC')->subDays(2)->toDateTimeString();
            $fiveDaysAgo = Time::now('UTC')->subDays(5)->toDateTimeString();
            ...
            $newsSeed = [
                [
                    ...
                    'excerpt'        => 'Portal resmi OPD hadir dengan tampilan baru dan akses layanan publik yang lebih mudah.',
                    'publicAuthor'   => 'Tim Humas OPD',
                    'source'         => 'Dinas Kominfo',
                    'metaTitle'      => 'Portal Resmi OPD Diluncurkan',
                    'metaDescription'=> 'Portal resmi OPD kini hadir dengan tampilan dan fitur terbaru untuk memudahkan layanan publik.',
                    'metaKeywords'   => 'portal opd, layanan publik, transformasi digital',
                    'thumbnail'      => null,
                ...
                [
                    ...
                    'excerpt'        => 'Workshop literasi digital digelar untuk meningkatkan kemampuan masyarakat memanfaatkan teknologi.',
                    'publicAuthor'   => 'Bidang Program',
                    'source'         => 'Bidang Program dan Layanan',
                    'metaTitle'      => 'Workshop Literasi Digital oleh OPD',
                    'metaDescription'=> 'OPD menyelenggarakan workshop literasi digital bagi masyarakat sebagai bagian program pemberdayaan.',
                    'metaKeywords'   => 'literasi digital, pemberdayaan masyarakat, layanan digital',
                    'thumbnail'      => null,
            ...
            foreach ($newsSeed as $item) {
                ...
                $newsTable->insert([
                    ...
                    'public_author'       => $item['publicAuthor'],
                    'source'              => $item['source'],
