...
class Profile extends BaseController
{
    ...
    public function update()
    {
        ...
        $rules = [
            ...
            'greeting'    => 'permit_empty',
            'tasks_functions' => 'permit_empty',
        ...
        $data = [
            ...
            'greeting'    => sanitize_rich_text($this->request->getPost('greeting')),
            'tasks_functions' => sanitize_rich_text($this->request->getPost('tasks_functions')),
