    ...
    <div class="row justify-content-center">
      <div class="col-lg-10">
        <div class="mb-4">
          ...
          <span class="hero-badge text-uppercase">Tugas & Fungsi</span>
          <h1 class="display-5 fw-bold mt-3 mb-3">Tugas Pokok dan Fungsi</h1>
        </div>
        
        <article class="surface-card profile-card">
          <div class="prose">
            <?= nl2br(esc($profile['tasks_functions'] ?? 'Tugas dan fungsi belum tersedia.')) ?>
          </div>
        </article>

        <?php if (!empty($profile['name'])): ?>
          <div class="mt-4 text-muted small">
            <p class="mb-0"><?= esc($profile['name']) ?></p>
          </div>
        <?php endif; ?>
      </div>
    </div>
