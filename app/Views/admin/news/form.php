...
<style>
  .news-form-layout .card {
    border-radius: 0.75rem;
  }

  .news-form-layout .news-form-sidebar {
    position: sticky;
    top: 96px;
  }
        ...
        <form id="newsForm" method="post" enctype="multipart/form-data" action="<?= $mode === 'edit' ? site_url('admin/news/update/'.$item['id']) : site_url('admin/news/store') ?>">
          ...
          <div class="row g-4 align-items-start news-form-layout">
                ...
                <div class="card shadow-sm h-100">
                                <div class="card-body p-4">
                                    <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3 mb-4">
                                      <div>
                                        <h5 class="fw-semibold mb-1">Informasi Berita</h5>
                                        <p class="text-muted small mb-0">Lengkapi judul dan konten utama. Slug akan terbentuk otomatis dari judul.</p>
                                      </div>
                                    </div>
            ...
            <div class="col-12 col-xl-4">
              <div class="news-form-sidebar d-flex flex-column gap-4">
                <div class="card shadow-sm h-100">
                                  <div class="card-body p-4">
