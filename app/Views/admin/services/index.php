...
<div class="row g-4">
  <div class="col-12">
    <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
      <div>
        <h4 class="fw-bold mb-0">Layanan</h4>
        <p class="text-muted mb-0 small">Kelola daftar layanan informatif yang akan tampil di halaman publik.</p>
      </div>
      <a class="btn btn-primary" href="<?= site_url('admin/services/create') ?>"><i class="bx bx-plus"></i> Tambah</a>
    </div>
    ...
    <div class="card">
      <div class="card-body">
        ...
        <table id="servicesTable" class="table table-striped table-sm align-middle">
          <thead>
            <tr>
            ...
            <tr>
              ...
              <td class="text-end">
                <div class="d-inline-flex flex-wrap justify-content-end gap-1">
                  <a href="<?= site_url('admin/services/edit/'.$service['id']) ?>" class="btn btn-sm btn-outline-secondary"><i class="bx bx-edit"></i> Ubah</a>
                  <form action="<?= site_url('admin/services/delete/'.$service['id']) ?>" method="post" onsubmit="return confirm('Hapus layanan ini?')" class="m-0">
                    <?= csrf_field() ?>
