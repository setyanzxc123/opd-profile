...
$routes->get('search/berita', 'Pages::beritaSearch', ['filter' => 'searchthrottle']);
$routes->get('search', 'Pages::globalSearch', ['filter' => 'searchthrottle']);
...
$routes->group('admin', [
    ...
    // Hero Sliders CMS - Clean & RESTful
