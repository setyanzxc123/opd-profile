...
class ThemeStyleService
{
    ...
    public static function compilePublicVariables(array $theme): array
    {
        ...
        return [
            ...
            '--surface-card'           => '#FFFFFF',
            '--surface-border'         => 'rgba(' . $neutralRgb . ', 0.12)',
            '--surface-border-strong'  => 'rgba(' . $neutralRgb . ', 0.18)',
            '--surface-shadow'         => '0 2px 8px rgba(' . $neutralRgb . ', 0.1), 0 1px 3px rgba(' . $neutralRgb . ', 0.06)',
            '--surface-shadow-sm'      => '0 1px 4px rgba(' . $neutralRgb . ', 0.08)',
